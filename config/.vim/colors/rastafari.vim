...
hi SpecialKey   guifg=#333333 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkgrey
...
hi cppcheckError       guifg=#aa2222 guibg=bg gui=none term=none cterm=none ctermfg=darkred
...
hi cppcheckStyle       guifg=#00aa00 guibg=bg gui=none term=none cterm=none ctermfg=darkgreen
hi cppcheckPerformance guifg=#3333ff guibg=bg gui=none term=none cterm=none ctermfg=blue
