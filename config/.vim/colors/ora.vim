...
exe "hi NonText"     .s:v.'fg='.s:gr1                .s:v.'=NONE cterm=bold'
...
exe "hi Title"       .s:v.'fg=fg'                    .s:v.'=NONE cterm=bold'
...
exe "hi Special"     .s:v.'fg='.s:dye
exe "hi Statement"   .s:v.'fg='.s:bro                .s:v.'=NONE cterm=bold'
exe "hi Todo"        .s:v.'fg=bg'    .s:v.'bg='.s:bro
exe "hi Type"        .s:v.'fg='.s:gre                .s:v.'=NONE'

exe "hi StorageClass"  .s:v."fg=".s:gre              .s:v."=bold"
exe "hi Structure"     .s:v."fg=".s:gre              .s:v."=bold"
exe "hi Typedef"       .s:v."fg=".s:gre              .s:v."=bold"

exe "hi SpecialChar"   .s:v."fg=".s:yel
exe "hi Tag"           .s:v."fg=".s:yel
exe "hi Delimiter"     .s:v."fg=".s:yel
exe "hi SpecialComment".s:v."fg=".s:yel
exe "hi Debug"         .s:v."fg=".s:yel
"}}}
