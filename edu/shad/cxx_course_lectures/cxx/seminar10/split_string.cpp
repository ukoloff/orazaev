...
int main() {
    std::string input = "Some $$ string $$ with $$ strange $$ delimeters";

    std::vector<std::string> strVec;

    Split(input, "", &strVec);

    printElements(strVec.begin(), strVec.end());
    ...
    printElements(m, Split(input, delimeters.begin(), delimeters.end(), m));


    std::cout << Join(strVec, "#") << std::endl;
